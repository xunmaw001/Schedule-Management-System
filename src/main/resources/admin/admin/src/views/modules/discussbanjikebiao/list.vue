...
export default {
  ...
  methods: {
	...
	this.$router.push({path:'/discussdiscussbanjikebiao',query:{refid:id}});
    },
    // 下载
    download(file){
      window.open(`${file}`)
