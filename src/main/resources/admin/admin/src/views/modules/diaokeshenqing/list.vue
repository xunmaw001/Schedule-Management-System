			...
			<el-form class="center-form-pv" :style='{"margin":"0 0 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"display":"block"}' >
					...
					<div :style='{"margin":"0 10px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#000","display":"inline-block","lineHeight":"40px","fontSize":"14px","fontWeight":"500","height":"40px"}' class="item-label">调课课程</label>
						<el-input v-model="searchForm.diaokekecheng" placeholder="调课课程" clearable></el-input>
					</div>
			...
			<!-- <div> -->
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#000","borderRadius":"0","background":"url(http://codegen.caihongy.cn/20220726/b87f4c4f9a0d4ed194c128c66d95e8bd.png) center center/cover","width":"99px","fontSize":"14px","height":"32px"}' v-if=" isAuth('diaokeshenqing','查看')" type="success" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#000","borderRadius":"0","background":"url(http://codegen.caihongy.cn/20220726/b87f4c4f9a0d4ed194c128c66d95e8bd.png) center center/cover","width":"99px","fontSize":"14px","height":"32px"}' v-if=" isAuth('diaokeshenqing','修改')" type="primary" size="mini" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>





							<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 6px 0","outline":"none","color":"#000","borderRadius":"0","background":"url(http://codegen.caihongy.cn/20220726/b87f4c4f9a0d4ed194c128c66d95e8bd.png) center center/cover","width":"99px","fontSize":"14px","height":"32px"}' v-if="isAuth('diaokeshenqing','删除') " type="danger" size="mini" @click="deleteHandler(scope.row.id)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
				<el-pagination
    ...
    getDataList() {
      ...
      let params = {
        ...
        order: 'desc',
          ...
          if(this.searchForm.diaokekecheng!='' && this.searchForm.diaokekecheng!=undefined){
            params['diaokekecheng'] = '%' + this.searchForm.diaokekecheng + '%'
          }
          if(this.searchForm.sfsh!='' && this.searchForm.sfsh!=undefined){
            params['sfsh'] = this.searchForm.sfsh
          }
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
          ...
          diaokekecheng: row.diaokekecheng,
          diaokeshijian: row.diaokeshijian,
          diaokeyuanyin: row.diaokeyuanyin,
