    ...
    <el-tabs tab-position="left" :style='{"border":"1px solid #9ce3b5","padding":"30px 20px","boxShadow":"0px 2px 6px #ccc,inset 0px 0px 600px 0px #e0f8e8","margin":"20px auto 0 auto","borderRadius":"4px","background":"#fff","width":"100%"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="80px">
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='xuesheng'" label="年级" prop="nianji">
            <el-input v-model="sessionForm.nianji" placeholder="年级" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='xuesheng'" label="教师姓名">
            <el-select v-model="sessionForm.jiaoshixingming" placeholder="请选择教师姓名" @change="jiaoshixingmingChange" >
              <el-option v-for="(item, index) in dynamicProp.jiaoshixingming" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='xuesheng'" label="教师工号" prop="jiaoshigonghao">
            <el-input v-model="sessionForm.jiaoshigonghao" placeholder="教师工号" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='jiaoshi'" label="教师工号" prop="jiaoshigonghao">
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='jiaoshi'" label="职称" prop="zhicheng">
            <el-input v-model="sessionForm.zhicheng" placeholder="职称" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='jiaoshi'" label="电话" prop="dianhua">
            <el-input v-model="sessionForm.dianhua" placeholder="电话" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='jiaoshi'" label="照片">
            <el-upload
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 10px","borderRadius":"0px","background":"none"}' v-if="userTableName=='jiaoshi'" label="班级" prop="banji">
            <el-input v-model="sessionForm.banji" placeholder="班级" ></el-input>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      if ('jiaoshi' == this.userTableName) {
        this.$set(this.rules, 'dianhua', [{ required: true, message: '请输入电话', trigger: 'blur' }]);
      }
			if ('jiaoshi' == this.userTableName) {
    ...
    methods: {
      init() {
        if ('xuesheng' == this.userTableName) {
          ...
          this.$http.get('option/jiaoshi/jiaoshixingming', {emulateJSON: true}).then(res => {
            if (res.data.code == 0) {
              this.dynamicProp.jiaoshixingming = res.data.data;
            }
          });
        }    
        if ('jiaoshi' == this.userTableName) {
      ...
      jiaoshixingmingChange(value) {
        this.$http.get('follow/jiaoshi/jiaoshixingming', {params: {columnValue: value}}).then(res => {
          if (res.data.code == 0) {
